...
var buildDir = Directory("./src/AngleSharp.Scripting.JavaScript/bin") + Directory(configuration);
...
Setup(() =>
{
    Information("Building version {0} of AngleSharp.Scripting.", version);
...
Task("Restore-Packages")
    ...
    .Does(() =>
    {
        NuGetRestore("./src/AngleSharp.Scripting.sln");
    });
...
Task("Build")
    ...
    .Does(() =>
    {
        ...
        {
            MSBuild("./src/AngleSharp.Scripting.sln", new MSBuildSettings()
        ...
        {
            XBuild("./src/AngleSharp.Scripting.sln", new XBuildSettings()
                .SetConfiguration(configuration)
                .SetVerbosity(Verbosity.Minimal)
            );
        }
...
Task("Copy-Files")
    ...
    .Does(() =>
    {
        ...
        { 
            buildDir + File("AngleSharp.Scripting.JavaScript.dll"),
            buildDir + File("AngleSharp.Scripting.JavaScript.xml")
        }, target);
        CopyFiles(new FilePath[] { "src/AngleSharp.Scripting.JavaScript.nuspec" }, nugetRoot);
    });
...
Task("Create-Package")
    ...
    .Does(() =>
    {
        ...
        var nuspec = nugetRoot + File("AngleSharp.Scripting.JavaScript.nuspec");

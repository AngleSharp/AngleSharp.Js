namespace AngleSharp.Scripting.JavaScript
{
    ...
    {
        public HashChangeEventPrototype(Engine engine)
            : base(engine)
        {
        ...
        {
            var obj = new HashChangeEventPrototype(engine.Jint)
            {
        ...
        {
            var reference = thisObj.TryCast<HashChangeEventInstance>(Fail).RefHashChangeEvent;
            return Engine.Select(reference.PreviousUrl);
        }
        ...
        {
            var reference = thisObj.TryCast<HashChangeEventInstance>(Fail).RefHashChangeEvent;
            return Engine.Select(reference.CurrentUrl);
        }

namespace AngleSharp.Scripting.JavaScript
{
    ...
    sealed partial class HTMLDocumentPrototype : HTMLDocumentInstance
    {
        ...
        {
            var reference = thisObj.TryCast<HTMLDocumentInstance>(Fail).RefHTMLDocument;
        ...
        {
            var instance = thisObj.TryCast<HTMLDocumentInstance>(Fail);
        ...
        {
            var instance = thisObj.TryCast<HTMLDocumentInstance>(Fail);
            var reference = instance.RefHTMLDocument;
